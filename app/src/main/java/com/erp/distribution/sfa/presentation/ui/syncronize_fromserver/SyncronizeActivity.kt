...
//            .subscribe(
//                {
//                    viewModel.subscribeListFdivisionByParent_FromRepoAndSaveToCache(it)
//                },
//                {
...
//        val observerFArea = viewModel.getFAreaFromRepoAndSaveToCache()
//            .map { data ->
//                data.map {
//                    it.modified = Date()
//                    it.created = Date()
...
//
//
//        val observerCustomer = viewModel.getFCustomerFromRepoAndSaveToCache()
//                .map { data ->
//                    data.map {
//                        it.modified = Date()
//                        it.created = Date()
