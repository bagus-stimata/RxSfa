...
interface RetrofitServiceFtPriceAlth {
    ...
    fun getAlltPriceAlthByDivisionAndShareToCompany(@Header("Authorization") authHeader: String?, @Path("fdivisionBean") fdivisionBean: Int, @Path("fcompanyBean") fcompanyBean: Int): Single<List<FtPriceAlthEntity>>
