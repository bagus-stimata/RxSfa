...
import com.erp.distribution.sfa.data.source.entity.FPromotionRulesdValidProducts
...
interface FPromotionRulesdValidProductsDao {
    ...
    fun insertAll(listFPromotionRulesdValidProducts: List<FPromotionRulesdValidProducts>)
