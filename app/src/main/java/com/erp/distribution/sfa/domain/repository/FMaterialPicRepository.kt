...
interface FMaterialPicRepository {
    ...
    fun getRemoteAllFMaterialPicByParentId(parentId: Int): Single<List<FMaterialPic>>
    ...
    fun getCacheAllFMaterialPicByDivision(divisionId: Int): LiveData<List<FMaterialPic>>
