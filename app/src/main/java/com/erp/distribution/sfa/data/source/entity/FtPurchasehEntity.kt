...
import com.erp.distribution.sfa.data.source.entity.modelenum.EnumRequestStatus
import com.erp.distribution.sfa.data.source.entity.modelenum.EnumStatusUpload
import com.erp.distribution.sfa.data.source.entity.modelenum.EnumTipeFakturBeli
...
@Entity(tableName = "FtPurchaseh")
class FtPurchasehEntity : Serializable {
