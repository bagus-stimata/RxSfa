package com.erp.distribution.sfa.presentation.ui.utils;
...
public class AlertDialogConfirm {
    ...
    public AlertDialogConfirm(Context context) {
        inizialize(context, "Terjadi kesalahan/error");
    }
    public AlertDialogConfirm(Context context, String message) {
        inizialize(context, message);

    }
    public void inizialize(Context context, String message){
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.alert_confirm_dialog, null);
